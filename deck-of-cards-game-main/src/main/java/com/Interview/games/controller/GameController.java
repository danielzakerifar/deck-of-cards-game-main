...
public class GameController {
	...
	public ResponseEntity<Deck> addDeck(@PathVariable Long id, @PathVariable Long deckId) {
		...
		service.addDeckToGame(game, deck);
	...
	public ResponseEntity<List<CardRepresentation>> getUndealtCardsCountBySuitAndValue(@PathVariable Long id) {
		Game game = service.findGame(id);
		List<CardRepresentation> cardList = service.getUndealtCardsCountBySuitAndValue(game);
